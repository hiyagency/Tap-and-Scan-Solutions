...
export const metadata: Metadata = { title: "Privacy", description: "How NFC BY ABHIGYAN handles enquiry information." };

export default function PrivacyPage() {
  return (
    <main className="legal-page section-shell">
      <Link className="brand" href="/"><Image src="/brand/tap-and-scan-logo.png" alt="" width={64} height={64} /><span><strong>NFC BY</strong><small>ABHIGYAN</small></span></Link>
      <article>
        <p className="eyebrow"><span /> Privacy</p>
        <h1>Your enquiry stays business-focused.</h1>
        <p>When you submit an enquiry, NFC BY ABHIGYAN stores the contact and project information you provide so we can respond, prepare a quotation and maintain an enquiry history.</p>
